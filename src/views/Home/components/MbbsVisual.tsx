        ...
        <div className="flex items-center">
            <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6 animate-fade-in lg:order-first order-last lg:mt-0 mt-8">
                    ...
                    <Button
                        variant="solid"
                        className="rounded-md !text-[15px] group inline-flex items-center px-6 py-4 text-lg transition-all duration-300 ease-in-out transform hover:scale-105 bg-primary text-white"
                    >
                        Get Started
