    ...
    return (
        <div className="w-full">
            <div className="max-w-7xl px-6 mx-auto py-4">
                <TitleAnimation>
                    <h1 className="text-2xl sm:text-4xl font-bold text-primary bg-clip-text">
                        Why Gogetwell.ai
                    </h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
                    {WhyMakwellData.map((item, index) => (
                        <ItemAnimation key={index} index={index}>
                            <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center">
