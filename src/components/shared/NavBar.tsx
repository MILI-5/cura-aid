...
const NavBar: React.FC = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-8 py-4 bg-white/60 dark:bg-gray-900/60 shadow-glass rounded-b-xl sticky top-0 z-50 backdrop-blur-md border-b border-neutral-100 dark:border-neutral-800 font-sans transition-all duration-300">
      <div className="flex items-center gap-4">
        <span className="text-3xl">🏥</span>
        <span className="text-2xl font-extrabold text-primary tracking-tight">Cliniq</span>
      </div>
      {/* Desktop Links */}
          ...
          {quickAddOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white/95 dark:bg-gray-900/95 rounded-xl shadow-lg py-2 z-50 animate-fade-in border border-neutral-100 dark:border-neutral-700 backdrop-blur-md">
              ...
              {quickActions.filter(action => action.roles.includes(role)).map(action => (
                <a key={action.to} href={action.to} className="block px-4 py-2 hover:bg-primary/10 dark:hover:bg-primary/20 rounded transition-colors" role="menuitem">{action.label}</a>
              ))}
            </div>
          )}
        </div>
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white/95 dark:bg-gray-900/95 rounded-xl shadow-lg py-2 z-50 animate-fade-in border border-neutral-100 dark:border-neutral-700 backdrop-blur-md">
              ...
              <a href="#" className="block px-4 py-2 hover:bg-primary/10 dark:hover:bg-primary/20 rounded transition-colors" role="menuitem">Profile</a>
              <a href="#" className="block px-4 py-2 hover:bg-primary/10 dark:hover:bg-primary/20 rounded transition-colors" role="menuitem">Settings</a>
              <a href="#" className="block px-4 py-2 hover:bg-error/10 dark:hover:bg-error/20 text-error transition-colors rounded" role="menuitem">Logout</a>
