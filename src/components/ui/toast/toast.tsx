...
toast.success = (message) => toast.push(<div className="text-green-600 font-semibold">{message}</div>);
toast.error = (message) => toast.push(<div className="text-red-600 font-semibold">{message}</div>);
toast.info = (message) => toast.push(<div className="text-blue-600 font-semibold">{message}</div>);
